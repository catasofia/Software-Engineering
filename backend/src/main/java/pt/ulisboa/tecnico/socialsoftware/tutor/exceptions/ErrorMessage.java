...
public enum ErrorMessage {
    ...
    AT_LEAST_ONE_ITEM_NEEDED_IN_A_GROUP("Questions need to have at least one item in A group."),
    AT_LEAST_ONE_ITEM_NEEDED_IN_B_GROUP("Questions need to have at least one item in B group."),
