...
public class ItemCombinationSlotCorrectAnswerDto implements Serializable {
    private Integer id;
    private Integer internId;
    private List<ItemCombinationSlot> correctCombinations;

    public ItemCombinationSlotCorrectAnswerDto(ItemCombinationSlot itemCombinationSlot) {
