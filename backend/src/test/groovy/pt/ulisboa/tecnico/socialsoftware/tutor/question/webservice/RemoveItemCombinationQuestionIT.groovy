...
class RemoveItemCombinationQuestionIT extends SpockTest {
    @LocalServerPort
    private int port
    ...
    def "remove an item combination question as teacher"() {
        given: 'a teacher'
        ...
        and: "if the question has been deleted"
        questionRepository.count() == 0L
    }

    def "cannot remove an item combination question as student"() {
        given: 'a student'
        user = new User(USER_1_NAME, USER_1_EMAIL, USER_1_EMAIL,
